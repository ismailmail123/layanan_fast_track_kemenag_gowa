...
// const THEMES = {
//   dark: {
//     headerBg:     "rgba(15,15,26,0.75)",
//     headerBorder: "rgba(255,255,255,0.08)",
//     navBg:        "rgba(15,15,26,0.92)",
//     navBorder:    "rgba(255,255,255,0.08)",
//     titleColor:   "#f1f5f9",
//     subColor:     "#94a3b8",
//     clockColor:   "#60a5fa",
...
//     toggleBorder: "rgba(255,255,255,0.12)",
//     toggleText:   "#94a3b8",
//     overlayBg:    "linear-gradient(135deg, rgba(15,15,26,0.88) 0%, rgba(26,26,46,0.85) 50%, rgba(22,33,62,0.88) 100%)"
//   },
//   light: {
...
//     toggleBorder: "#dde5f3",
//     toggleText:   "#64748b",
//     overlayBg:    "linear-gradient(135deg, rgba(240,244,255,0.88) 0%, rgba(232,238,255,0.85) 50%, rgba(240,247,255,0.88) 100%)"
//   }
// };
...
//       {/* ── LAYER 1: Gambar background qr.png ──────── */}
//       <div style={{
//         position: "fixed",
//         inset: 0,
//         backgroundImage: "url('/pemasyarakatan.jpg')",
...
//       {/* ── LAYER 2: Color overlay di atas gambar ──── */}
//       <div style={{
//         position: "fixed",
//         inset: 0,
...
//               fontSize: 17, fontWeight: 700,
//               fontVariantNumeric: "tabular-nums",
//               color: T.clockColor, letterSpacing: 1
//             }}>{jam}</div>
//             <div style={{ fontSize: 9, color: T.clockSub, textTransform: "uppercase", letterSpacing: 0.5 }}>
//               WITA
//             </div>
...
// App.js (sudah bagus, hanya sedikit penyesuaian)
import { useState, useEffect } from "react";
import ScanPage from "./ScanPage";
import HariIniPage from "./HariIniPage";
import SemuaDataPage from "./SemuaDataPage";
...
export const THEMES = {
  dark: {
    ...
    navActive:  "#60a5fa",
    navInactive:"#475569",
    navActiveBg:"rgba(59,130,246,0.12)",
    toggleBg:   "rgba(255,255,255,0.08)",
    toggleBorder:"rgba(255,255,255,0.15)",
    overlayBg:  "linear-gradient(135deg, rgba(15,15,26,0.85) 0%, rgba(26,26,46,0.82) 50%, rgba(22,33,62,0.85) 100%)"
  },
  light: {
    appBg:      "linear-gradient(135deg, #f0f4ff 0%, #e8eeff 50%, #f0f7ff 100%)",
    headerBg:   "rgba(255,255,255,0.85)",
    ...
    toggleBg:   "#f1f5f9",
    toggleBorder:"#dde5f3",
    overlayBg:  "linear-gradient(135deg, rgba(255,255,255,0.85) 0%, rgba(248,250,255,0.82) 50%, rgba(255,255,255,0.85) 100%)"
  }
};
